        ...
        <div className="send">
          {loading ? (
            ...
            <button onClick={() => handleAddingTask(newTaskTitle)} >
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 20" strokeWidth="2" stroke="#064789" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v2411z" fill="none"></path>
